  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item active open">
      ...
      <li class="menu-item active">
        <a href="profile-user.html" class="menu-link" >
                    <div>Profile</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="profile-teams.html" class="menu-link" >
                    <div>Teams</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="profile-projects.html" class="menu-link" >
                    <div>Projects</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="profile-connections.html" class="menu-link" >
                    <div>Connections</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="account-settings-account.html" class="menu-link" >
                    <div>Account</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="account-settings-security.html" class="menu-link" >
                    <div>Security</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="account-settings-billing.html" class="menu-link" >
                    <div>Billing &amp; Plans</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="account-settings-notifications.html" class="menu-link" >
                    <div>Notifications</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="account-settings-connections.html" class="menu-link" >
                    <div>Connections</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="help-center-landing.html" class="menu-link" >
                    <div>Landing</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="help-center-categories.html" class="menu-link" >
                    <div>Categories</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="help-center-article.html" class="menu-link" >
                    <div>Article</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="misc-error.html" class="menu-link"  target="_blank" >
                    <div>Error</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="misc-under-maintenance.html" class="menu-link"  target="_blank" >
      ...
      <li class="menu-item ">
        <a href="misc-comingsoon.html" class="menu-link"  target="_blank" >
                    <div>Coming Soon</div>
        </a>
      ...
      <li class="menu-item ">
        <a href="misc-not-authorized.html" class="menu-link"  target="_blank" >
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <li class="nav-item dropdown-language dropdown me-2 me-xl-0">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li>
                <a class="dropdown-item" href="profile-user.html" data-language="fr">
                  <i class="fi fi-fr fis rounded-circle fs-4 me-1"></i>
                  <span class="align-middle">French</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="profile-user.html" data-language="de">
                  <i class="fi fi-de fis rounded-circle fs-4 me-1"></i>
                  <span class="align-middle">German</span>
                </a>
              </li>
              <li>
                <a class="dropdown-item" href="profile-user.html" data-language="pt">
              ...
              <div class="dropdown-shortcuts-list scrollable-container">
                ...
                <div class="row row-bordered overflow-visible g-0">
                  ...
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="account-settings-account.html" class="stretched-link">Setting</a>
                ...
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="help-center-landing.html" class="stretched-link">Help Center</a>
  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="user-profile-header-banner">
        <img src="../../demo/assets/img/pages/profile-banner.png" alt="Banner image" class="rounded-top">
      </div>
      <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
          <img src="../../demo/assets/img/avatars/1.png" alt="user image" class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img">
        </div>
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link" href="profile-teams.html"><i class='bx bx-group'></i> Teams</a></li>
      <li class="nav-item"><a class="nav-link" href="profile-projects.html"><i class='bx bx-grid-alt'></i> Projects</a></li>
      <li class="nav-item"><a class="nav-link" href="profile-connections.html"><i class='bx bx-link-alt'></i> Connections</a></li>
    </ul>
  </div>
</div>
<!--/ Navbar pills -->
        ...
        <ul class="timeline ms-2">
          ...
          <li class="timeline-item timeline-item-transparent">
            ...
            <div class="timeline-event">
              ...
              <p class="mb-2">Sent by Mollie Dixon <img src="../../demo/assets/img/avatars/4.png" class="rounded-circle ms-3" alt="avatar" height="20" width="20"></p>
              <div class="d-flex flex-wrap gap-2">
                <a href="javascript:void(0)" class="me-3">
                  <img src="../../demo/assets/img/icons/misc/pdf.png" alt="Document image" width="20" class="me-2">
                  <span class="h6">App Guidelines</span>
                </a>
                <a href="javascript:void(0)">
                  <img src="../../demo/assets/img/icons/misc/xls.png" alt="Excel image" width="20" class="me-2">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-start">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../demo/assets/img/avatars/10.png" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
            ...
            <ul class="list-unstyled mb-0">
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../demo/assets/img/icons/brands/react-label.png" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../demo/assets/img/icons/brands/support-label.png" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../demo/assets/img/icons/brands/figma-label.png" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../demo/assets/img/icons/brands/vue-label.png" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-2">
              ...
              <li class="mb-3">
                <div class="d-flex align-items-center">
                  <div class="d-flex align-items-start">
                    <div class="avatar me-3">
                      <img src="../../demo/assets/img/icons/brands/twitter-label.png" alt="Avatar" class="rounded-circle" />
                    </div>
                    <div class="me-w">
