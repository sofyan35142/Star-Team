        ...
        <div class="chatbox">
            ...
            <div class="custom-tab-1">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active showz" id="chat" role="tabpanel">
                ...
                <div class="tab-content" id="menu">
                    ...
                    <div class="tab-pane fade" id="components">
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li class="mega-menu mega-menu-xl">
                                <a class="has-arrow" href="/perlu dikirim" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24">
                    ...
                    <div class="tab-pane fade" id="forms">
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li><a class="has-arrow ai-icon" href="/tabkembali" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24" />
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{asset ('fotowajah/' .Auth::user()->foto_wajah)}}" width="20" alt="" />
                                    <div class="header-info">
                                        <span>Hey, <strong>{{ Auth::user()->username }}</strong></span>
