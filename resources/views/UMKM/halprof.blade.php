            ...
            <div class="info-contact clearfix">
                    ...
                    <div class="row">
                        ...
                        <address>
                            <div class="address clearfix form-group">
                                ...
                                <div class="text">Toko KU</div>
                            </div>
                            <div class="phone form-group">
                                <div class="icon">
                                    <i class="fa fa-envelope-open-o"></i>
                                </div>
                                <div class="text">Email:Tokoid@gmail.com</div>
                            </div>
                            <div class="comment">             
                            </div>
                            <div class="address clearfix form-group">
                                ...
                                <div class="text">Perusahaan Saya,Kec.Sukorejo Kab.Pasuruan</div>
                            </div>
                            <div class="phone form-group">
                                <div class="icon">
                                    <i class="fa fa-phone"></i>
                                </div>
                                <div class="text">Telepon : 085706538287</div>
                            </div>
                            <div class="comment">             
                            </div>
                        </address>
                ...
                {{-- <div class="col-lg-8 col-sm-8 col-xs-12 contact-form">
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <label class="col-sm-2 control-label" for="input-name">Toko Nama Anda</label>
                        <div class="col-sm-10">
                            <input type="text" name="name" value="" id="input-name" class="form-control">
                            </div>
                        </div>
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="input-email">Alamat email</label>
                            <div class="col-sm-10">
