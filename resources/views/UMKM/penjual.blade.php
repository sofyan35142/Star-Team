    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="chatbox">
            ...
            <div class="custom-tab-1">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade {{ request()->is('toko') ? 'active show' : '' }}" id="chat"
                        role="tabpanel">
        ...
        <div class="fixed-content-box">
            ...
            <div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
                <div class="tab-content" id="menu">
                    ...
                    <div class="tab-pane fade {{ request()->is('toko') ? 'active show' : '' }}" id="dashboard"
                        role="tabpanel">
                        <ul class="metismenu tab-nav-menu">
                            <li class="nav-label">DASHBOARD</li>
                            <li>
                                <a class="has-arrow" href="/toko" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div class="tab-pane fade {{ request()->is('produksaya', 'tambahprodukbaru') ? 'active show' : '' }}"
                        id="apps">
                        <ul class="metismenu tab-nav-menu">
                            <li class="nav-label">Produk</li>
                            <li>
                                <a href="/produksaya" class="ai-icon active" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <li>
                                <a href="/tambahprodukbaru" class="ai-icon active" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24"></polygon>
                    ...
                    <div class="tab-pane fade {{ request()->is('perludikirim') ? 'active show' : '' }}"
                        id="components">
                        <ul class="metismenu tab-nav-menu">
                            <li class="nav-label">Pengiriman</li>
                            <li>
                                <a href="/perludikirim" class="ai-icon" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <span class="nav-text">Perlu Dikirim</span>
                                </a>
                            </li>
                            <li>
                                <a href="/aturpengiriman" class="ai-icon active" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24"></polygon>
                                    ...
                                    <span class="nav-text">Pengaturan Pengiriman</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-pane fade {{ request()->is('pesananseller') ? 'active show' : '' }}" id="forms">
                        <ul class="metismenu tab-nav-menu">
                            <li class="nav-label">Pesanan</li>
                            <li><a class="has-arrow ai-icon" href="pesananseller" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24" />
                        ...
                        <ul class="metismenu tab-nav-menu">
                            ...
                            <li>
                                <a href="#" class="ai-icon active" aria-expanded="false">
                                    ...
                                    <span class="nav-text">Alamat Saya</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('fotowajah/' . Auth::user()->foto_wajah) }}" width="20"
                                        alt="" />
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/tampilprof" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="nav menu-tabs">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('toko') ? 'open active' : '' }}" data-toggle="tab"
                            href="#dashboard">
                            <svg id="icon-home1" xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('produksaya', 'tambahprodukbaru') ? 'open active' : '' }}"
                            data-toggle="tab" href="#apps">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('perludikirim') ? 'active' : '' }}" data-toggle="tab"
                            href="#components">
                            <svg id="icon-bootstrap" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('pesananseller') ? 'active' : '' }}" data-toggle="tab"
                            href="#forms">
                            <svg id="icon-forms" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#extra">
                            <svg id="icon-pages" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="/logout" class="logout-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://dexignlab.com/" target="_blank">Team
                        Star</a> 2022</p>
            </div>
        </div>
        <!--**********************************
    ...
    ***********************************-->
    ...
    <script>
        $(document).ready(function() {
            $("#table1,#perludikirim, #tableselesai, #tabeldikirim").DataTable();
        });
        $(document).ready(function() {
            $("#tabeldnjk").DataTable();
        });
        $(document).ready(function() {
            $("#tabeltelahdiproses").DataTable();
        });
        $(document).ready(function() {
            $("#table2").DataTable();
        });
        ...
        $(document).ready(function() {
            $('#tabeldibatalkan2').DataTable();
        });
        $(document).ready(function() {
            $('#tabeldibatalkan1').DataTable();
        });
        $(document).ready(function() {
            $('#tabeldikirim').DataTable();
        });
        $(document).ready(function() {
            $('#tabeldibatalkan3').DataTable();
        });
    </script>
    <script>
        // sweet alert produk
        $('.swadikap').click(function() {
            var dapid = $(this).attr('data-id');
            var danam = $(this).attr('data-nama');
            Swal.fire({
                title: 'Apakah Kamu yakin?',
                text: "Produk dengan nama " + danam + "",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire(
                        'Terhapus!',
                        'Produk' + danam + ' terhapus',
                        'success'
                    )
                }
            })
        });
        //sweet alert kategori
        $('.delete').click(function() {
            var kategoriid = $(this).attr('data-id');
            var kategori = $(this).attr('data-kategori');
            Swal.fire({
                title: 'Apakah Kamu yakin?',
                text: "Menghapus data kategori " + kategori + "",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    window.location = "/kategorihapus/" + kategoriid + ""
                    Swal.fire(
                        'Terhapus!',
                        'Data kategori ' + kategori + ' terhapus',
                        'success'
                    )
                }
            })
