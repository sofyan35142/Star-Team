                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="http://127.0.0.1:8000/fotowajah/-" width="20" alt="" />
                                    <div class="header-info">
                                        <span>Hallo, <strong>if</strong></span>
                                        <small>Toko</small>
                                    </div>
                                </a>
                            ...
                            <div class="card-header border-0 pb-0">
                                <div class="clearfix">
                                    <div class="card-title">
                                        <h5><i class="fa-regular fa-file-lines"></i><b
                                                style="margin-left:1pc;">Belum Bayar</b></h5>
                                    </div>
                                    <span>Pesanan Akan Dibatalkan Bila Pembayaran Tidak Dilakukan sampai 10 November
                                        2022(minggu). Silahkan tunggu sampai pembayaran dikonfirmasi SLICK sebelum
                                        mengirimkan barang</span>
                                </div>
                            ...
                            <div class="card-header border-0 pb-0">
                                <div class="clearfix">
                                    <div class="card-title">
                                        ...
                                        <h5><i class="fa-regular fa-file-lines"></i><b style="margin-left:1pc;">No.
                                                Pesanan</b></h5>
                                    ...
                                    <div class="card-title">
                                        ...
                                        <h5><i class="fa-solid fa-location-dot"></i><b
                                                style="margin-left:1pc;">Alamat Pengiriman</b></h5>

                                    </div>
                                    <div class="card-text">
                                        <span>
                                            Sulthon, 087859990555
                                        </span>
                                        <p>
                                            Gendol, RT.3/RW.2, Pakukerto, SUKOREJO, KAB. PASURUAN, JAWA TIMUR, ID, 67161
                                        </p>
                                    </div>
                                    <br>
                                    <div class="card-title">

                                        <h5><i class="fa-regular fa-user"></i><b style="margin-left:1pc;">Informasi
                                                Dropshipper</b></h5>
                                    ...
                                    <div class="card-text">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <h5><i class="fa-solid fa-truck-fast"></i><b
                                                    style="margin-left:1pc;">Informasi Jasa Kirim</b></h5>
                                        ...
                                        <div class="card-text">
                                            <span>
                                                <b>Paket 1</b>: Reguler (Cashless) | J&T Express | <a href="#"
                                                    class="text-white bg-primary">#JP245643987</a>
                                            </span>
                                            <div class="media pt-3 pb-3">
                                                <img src="fotoproduk/foto3.jpg" alt="image"
                                                    class="mr-3 rounded" width="75">
                                                <div class="media-body">
                                                    <p class="mb-0">Total 1 Produk</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-xxl-12 col-md-12">
                        <div class="card">
                            <div class="card-header border-0 pb-0" style="margin-bottom: inherit">
                                <div class="clearfix">
                                    <div class="card-text">
                                        <img src="/fotowajah/poster.jpeg" style="border-radius: 50%;"
                                            width="40px" height="40px"
                                            style="position: relative; float: right; margin-right: 50px;"></a> Sulthon
                                        </h3>
                                        <a href="javascript:void()" class="btn btn-outline-secondary"
                                            style="position: absolute; float: right;left:54pc"><i
                                                class="fa-solid fa-comments"></i> Chat Sekarang</a>
                                        <a href="javascript:void()" class="btn btn-secondary"
                                            style="position: absolute; float: right;left:64pc">Ikuti</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-header border-0 pb-0">
                                <div class="clearfix">
                                    <div class="card-title">
                                        ...
                                        <h5><i class="fa-regular fa-credit-card"></i><b
                                                style="margin-left:1pc;">Informasi Pembayaran</b> </h5>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="display" style="min-width: 985px">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td><img src="fotoproduk/foto3.jpg" alt="sepatu"
                                                                width="100px" style="float: left"><b>Sepatu
                                                                Sneakers</b> <br><br>
                                                            <span>Variasi : Hitam Putih <br> Ukuran: 39</span>
                                                        </td>
                                                        <td class="text-right">Rp220.000</td>
                                        ...
                                        <td  class="text-right">Rp165.000</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td class="text-right">
                                                            <h6>Ongkos Kirim yang diteruskan oleh Slick kepada Kurir
                                                            </h6>
                                                        </td>
                                                        <td class="text-right"></td>
                                                        <td class="text-right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td class="text-right">
                                                            <h6>Gratis Ongkir dari Slick</h6>
                                                        </td>
                                                        <td class="text-right"></td>
                                                        <td class="text-right">
                                                            <h6>Rp10.000</h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td class="text-right">
                                                            <h6>Diskon Voucher Ditanggung Penjual</h6>
                                                        </td>
                                                        <td class="text-right"></td>
                                                        <td class="text-right">
                                                            <h6>-Rp5.000</h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td class="text-right">
                                                            <h6>Voucher Ditanggung Penjual -
                                                                SCV-40248773256745692;FSV-823774023898457</h6>
                                                        </td>
                                                        <td class="text-right"></td>
                                                        <td class="text-right">
                                                            <h6>-Rp5.000</h6>
                                                    ...
                                                    <td class="text-right"></td>
                                                    <td class="text-right">
                                                        <h4 style="color: red">Rp.200.000</h4>
                                                    </td>
                                                    </tr>
                                                </tbody>
                                            </table>
