            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col-style">
                    <div class="infos-footer">
                        <a href="#"><img src="landingpage/image/catalog/logo1.png" alt="image"
                                height="200px"></a>
                        <ul class="menu">
                            <li class="adres">
                                Kecamatan Sukorejo
                            ...
                            <div class="box-information box-footer">
                                ...
                                <div class="modcontent">
                                    <ul class="menu">
                                        ...
                                        <li><a href="#">Kebijakan Slick</a></li>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 col-style">
                    <div class="box-information box-footer">
                        <div class="module clearfix">
                            ...
                            <div class="modcontent">
                                <ul class="menu">
                                    <li><a href="/berbelanja">Cara Belanja</a></li>
                                    <li><a href="/kembali">Pengembalian Produk</a></li>
                    ...
                    <div class="box-information box-footer">
                        <div class="module clearfix">
                            ...
                            <div class="modcontent">
                                <ul class="menu">
                                    <li><a href="/berjualan">Cara Berjualan</a></li>
