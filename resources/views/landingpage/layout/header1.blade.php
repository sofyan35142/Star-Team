                            ...
                            <ul class="top-link list-inline hidden-lg hidden-md">
                                <li class="account" id="my_account">
                                    <a href="#" title="My Account " class="btn-xs dropdown-toggle"
                                        data-toggle="dropdown"> <span class="hidden-xs">Akun Saya </span> <span
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="navbar-logo col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="logo"><a href="index.html"><img src="landingpage/image/catalog/4.png"
                                                ...
                                                <div class="container-mega">
                                                    <ul class="megamenu" data-transition="slide"
                                                        ...
                                                        <li class="">
                                                            ...
                                                            <a href="/halutama" class="clearfix">
                                                        ...
                                                        <li class="with-sub-menu hover">
                                                            ...
                                                            <div class="sub-menu" style="width: 25%; right: auto;">
                                                                <div class="content">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="column">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <ul class="row-list">
                                                                                        ...
                                                                                        <li><a href="/historiorder">Riwayat Pesanan</a></li>
                                                                                        <li><a href="/favorit">Produk Favorit</a></li>
                                                                                    </ul>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <ul class="row-list">
                                                                                ...
                                                                                <li><a class="subcategory_item"
                                                                                        href="/kebijakanpriv">Kebijakan Privasi</a></li>
                                                                                <li><a class="subcategory_item"
                                                                                        href="/hub">Kontak Kami</a></li>
                                                                                <li><a class="subcategory_item"
                        ...
                        <div class="middle-right col-lg-4 col-md-3 col-sm-6 col-xs-8">
                            <div class="signin-w  hidden-sm hidden-xs">
                                <ul class="signin-link blank">
                                    <li class="log login"><i class="fa fa-lock"></i> <a class="link-lg" href="/login">Masuk </a> atau <a href="/registrasi">Daftar</a>
                                        <br>
                                     <br><a style="{{ Route::currentRouteNamed('profiluser','notifikasi','alamat', 'sidebarpenjual', 'vouchertoko', 'pesanansaya') ? 'display:none' : '' }}" href="/sidebarpenjual"><i class="fa-solid fa-user"></i> Profile Saya</a></li>
                                </ul>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Souvenir Pesta</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Mainan Olahraga</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Pakaian Pria
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Pakaian Wanita</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Pakaian Anak</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Aksesoris Fashion</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Televisi
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Kulkas</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Headset</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Speaker</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Hair Care
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Body Care</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Skin Care</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Perawatan Kuku</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Perawatan Mulut
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Obat Tradisional</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Bahan Pokok
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Susu & Olahan</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Makanan Ringan</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Menu Sarapan</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Segar & Beku</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Handuk
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Rak</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Tempat Sabun</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Sepatu
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Sandal</a>
                                                                                                </li>
                                                                                                {{-- <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> SD card</a>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Vitamin
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Boneka</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Popok</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Edukatif</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Travelling Kit</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Mainan & Games
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Action Figure</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> CD & DVD</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Buku Tulis
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Alat Tulis</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Perlengkapan Menggambar</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Tali & Selotip</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Alat Makan</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Meja</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Lemari</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Selimut</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Wallpaper Dinding</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Alat Pancing
                                                                                                      </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Sepatu Olahraga</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu"> Bersepeda</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Diving Renang</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Sepak Bola</a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a href="/kategorilanding"
                                                                                                        class="main-menu">Fitness</a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
                        ...
                        <div class="bottom3 col-lg-3 col-md-3 col-sm-3">
                            ...
                            <!--cart-->
                            <div class="shopping_cart {{ Route::is('keranjang','checkout','historiorder','informasiorder') ? 'none' : '' }}">
                                            ...
                                            <div class="shopcart-inner">
                                                ...
                                                <span class="total-shopping-cart cart-total-full">
                                                    ...
                                                    <span class="items_cart">0</span><span class="items_cart2">
                                                        barang</span><span class="items_carts"> - Rp. 0 </span>
                                                </span>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-center" style="width:70px">
                                                                        <a href="product.html">
                                                                            <img src="landingpage/image/catalog/demo/product/80/1.jpg" style="width:70px" alt="Yutculpa ullamcon" title="Yutculpa ullamco" class="preview">
                                                                        </a>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-center" style="width:70px">
                                                                        <a href="product.html">
                                                                            <img src="landingpage/image/catalog/demo/product/80/2.jpg" style="width:70px" alt="Xancetta bresao" title="Xancetta bresao" class="preview">
                                                                        </a>
                                                                    </td>
                                    ...
                                    <ul class="dropdown-menu pull-right shoppingcart-box" role="menu">
                                        ...
                                        <li>
                                            <div>
                                                ...
                                                <p class="text-right"> <a class="btn view-cart" href="/keranjang"><i class="fa fa-shopping-cart"></i>Keranjang</a>&nbsp;&nbsp;&nbsp;
