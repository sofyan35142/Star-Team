        ...
        <div class="container">
            <div class="row">
                <div class="header-top-left col-lg-7 col-md-8 col-sm-6 col-xs-4">
                    <div class="hidden-sm hidden-xs welcome-msg"><b><a href="/toko">Seller||</a>Selamat datang di
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    <div class="logo"><a href="#"><img src="landingpage/image/catalog/4.png" title="Your Store"
                ...
                <div class="middle-right col-lg-4 col-md-3 col-sm-6 col-xs-8">
                    <div class="signin-w  hidden-sm hidden-xs">
                        <ul class="signin-link blank">
                            <li class="log login"><i class="fa fa-lock"></i> <a class="link-lg" href="/login">Masuk
                                        ...
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu"> Skin Care</a>
                                                    </li>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">
                                                            Make Up</a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Perawatan Mulut
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Obat-obatan</a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Susu & Olahan</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Menu Sarapan</a>
                                                    </li>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Segar & Beku</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu"> Tempat Sabun</a>
                                                    </li>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">
                                                            Kloset</a>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Sikat & Spons</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Mainan & Games
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Action Figure</a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Alat Tulis</a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Alat Makan</a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="col-sm-12 hover-menu">
                                            <div class="menu">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu"> Bersepeda</a>
                                                    </li>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">
                                                            Hiking</a>
                                                    ...
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Diving Renang</a>
                                                    </li>
                                                    <li>
                                                        <a href="/kategorilanding" class="main-menu">Sepak Bola</a>
                                                    </li>
                                                    <li>
                ...
                <form method="GET" action="/pencarian">
                    <div id="search0" class="search input-group form-group">
                        ...
                        <input class="autosearch-input form-control" type="text" value="" size="50"
                            autocomplete="off" placeholder="Cari Toko,Produk" name="search">
                                    ...
                                    <td class="text-center" style="width:70px">
                                        <a href="#">
                                            <img src="../landingpage/image/catalog/demo/product/270/produk5.jfif"
                                                style="width:70px" alt="Yutculpa ullamcon" title="Yutculpa ullamco"
                                                class="preview">
                                        </a>
                                    </td>
                                    <td class="text-left"> <a class="cart_product_name" href="#">Sikat Gigi</a>
                                    </td>
