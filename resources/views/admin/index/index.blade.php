    ...
    ***********************************-->
	<div id="main-wrapper">
		...
		<div class="fixed-content-box">
			...
			<div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
				<div class="tab-content" id="menu">
					...
					<div class="tab-pane fade {{ Request::is('dashboard') ? 'active show' : '' }}" id="dashboard" role="tabpanel">
					...
					<div class="tab-pane fade {{ Request::is('akunpenjual') ? 'active show' : '' }}" id="apps">
						<ul class="metismenu tab-nav-menu">
							<li class="nav-label">Akun</li>
							<li><a href="/akunpenjual">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24" />
									...
									<span class="nav-text">Akun Penjual</span>
							...
							<li>
								<a href="/akunpembeli">
									...
									<span class="nav-text">Akun Pembeli</span>
					...
					<div class="tab-pane fade {{ Request::is('pembayaran','pengiriman', 'addpembayaran', 'addpengiriman') ? 'active show' : '' }}" id="table">
						<ul class="metismenu tab-nav-menu">
					...
					<div class="tab-pane fade {{ Request::is('kategoriadmin', 'addkategori', 'subkategori', 'addsubkategori') ? 'active show' : '' }}" id="extra">
						<ul class="metismenu tab-nav-menu">
							<li class="nav-label">Kategori</li>
							<li><a href="/kategoriadmin">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<polygon points="0 0 24 0 24 24 0 24" />
											<path d="M5.85714286,2 L13.7364114,2 C14.0910962,2 14.4343066,2.12568431 14.7051108,2.35473959 L19.4686994,6.3839416 C19.8056532,6.66894833 20,7.08787823 20,7.52920211 L20,20.0833333 C20,21.8738751 19.9795521,22 18.1428571,22 L5.85714286,22 C4.02044787,22 4,21.8738751 4,20.0833333 L4,3.91666667 C4,2.12612489 4.02044787,2 5.85714286,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3" />
							...
							<li class="nav-item dropdown header-profile">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a href="/logout" class="dropdown-item ai-icon">
										...
										<span class="ml-2" href="/logout">Logout </span>
									</a>
								</div>
							</li>
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="nav menu-tabs">
					...
					<li class="nav-item">
						<a class="nav-link {{ Request::is('dashboard') ? 'active show' : '' }}" data-toggle="tab" href="#dashboard">
					...
					<li class="nav-item">
						<a class="nav-link {{ Request::is('akunpenjual') ? 'active show' : '' }}" data-toggle="tab" href="#apps">
					...
					<li class="nav-item">
						<a class="nav-link {{ Request::is('pembayaran','pengiriman') ? 'active show' : '' }}" data-toggle="tab" href="#table">
					...
					<li class="nav-item">
						<a class="nav-link {{ Request::is('form') ? 'active show' : '' }}" data-toggle="tab" href="#forms">
					...
					<li class="nav-item">
						<a class="nav-link {{ Request::is('kategori','kategoriadmin') ? 'active show' : '' }}" data-toggle="tab" href="#extra">
			...
			<a href="/logout" class="logout-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out">
					<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
					<polyline points="16 17 21 12 16 7"></polyline>
					<line x1="21" y1="12" x2="9" y2="12"></line>
				</svg></a>
        ...
        ***********************************-->
		<div class="footer">
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="http://dexignlab.com/" target="">TeamStar</a> 2022</p>
			</div>
		</div>
		<!--**********************************
            Footer end
