...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/auth/register-cover by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Aug 2022 10:56:19 GMT -->
  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
      <div class="w-100 d-flex justify-content-center">
        <img src="{{ asset("template/demo/assets/img/illustrations/girl-with-laptop-light.png") }}" class="img-fluid" alt="Login image" width="700" data-app-dark-img="illustrations/girl-with-laptop-dark.png" data-app-light-img="illustrations/girl-with-laptop-light.png">
  ...
  <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <form  class="mb-3" action="{{ route('simpanregistrasi') }}" method="post">
            {{ csrf_field() }}
          <div class="mb-3">
