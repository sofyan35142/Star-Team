        ...
        <div class="main-container container">
            ...
            <div class="row">
                <div id="content" class="col-sm-12">
                    <h3>Kebijakan Barang yang Dilarang</h3>
                    <br/>
                    <br/>
                    <p> <div class="text-center">KEBIJAKAN BARANG YANG DILARANG DAN DIBATASI</div>
                        <br/>
                        Merupakan tanggung jawab Penjual untuk memastikan bahwa barang yang mereka ajukan mematuhi semua undang-undang dan diizinkan untuk didaftarkan untuk dijual sesuai dengan ketentuan dan kebijakan Slick sebelum pendaftaran barang pada platform penjualan. Untuk kenyamanan Penjual, di bawah ini Slick telah menyediakan pedoman singkat tentang barang yang dilarang dan dibatasi yang tidak boleh dijual di Slick. Slick akan memperbarui pedoman ini dari waktu ke waktu bila diperlukan. Silakan kunjungi halaman ini secara teratur untuk melihat pembaruan.
                    </p>
                </div>
            </div>
            <div class="row">
                <div id="content" class="col-sm-12">
                    ...
                    <strong>1.	PELANGGARAN TERHADAP PERSYARATAN LAYANAN KAMI</strong>
                    <br/>
                    <br/>
                    <p> Pelanggaran terhadap Kebijakan Barang yang Dilarang dan Dibatasi ini dapat membuat Penjual dikenai berbagai tindakan yang merugikan, termasuk tetapi tidak terbatas pada salah satu atau semua hal berikut:
                        <br/>                       
                        <br/>
                    ...
                    <strong>2.	DAFTAR BARANG YANG DILARANG DAN DIBATAS</strong>
                    <br/>
                    <br/>
                    <p> <b>A. Barang Terkait Makanan dan Minuman</b>
                        <br/>
                        <br/>
                        ...
                        <br/>
                        <br/>
                       <b>B. Barang Elektronik yang Dibatasi</b>
                        <br/>
                        <br/> 
                        ...
                        <br/>
                        <br/> 
                        (ix)	Jasa: Kecuali secara tegas diizinkan oleh Slick, penyediaan jasa, termasuk tetapi tidak terbatas pada jasa yang bersifat seksual atau ilegal atau melanggar Persyaratan  Layanan dilarang di Situs;
                        <br/>
                        <br/> 
                        ...
                        <br/>
                        <br/> 
                        (xiv)	Segala jenis hewan dan tumbuhan namun tidak terbatas pada tanaman, benih, atau kecambah yang dilarang diperjualbelikan berdasarkan hukum Republik Indonesia;
                        <br/>
                        <br/> 
                        ...
                        <br/>
                        <br/> 
                        (xxi)	Mata uang termasuk, dengan tidak terbatas pada, mata uang kuno atau mata uang lama dan mata uang digital;
                        <br/>
                        <br/> 
                        ...
                        <br/>
                        <br/> 
                        (xxxii)	Produk tembakau atau terkait tembakau, termasuk dengan tidak terbatas pada rokok elektronik (kecuali rokok elektronik yang masuk ke dalam kategori elektronik- vaporizer);
                        <br/>
                        <br/> 
                        ...
                        <br/>
                        <br/> 
                        (xxxv)	Barang impor bekas (termasuk di dalamnya pakaian impor bekas);
                        <br/>
                        <br/> 
                        (xxxvi) Barang dewasa penunjang kegiatan seksual termasuk namun tidak terbatas pada alat bantu seks, pornografi, dan obat-obatan dewasa, kecuali barang yang termasuk alat kesehatan yang telah memiliki izin edar yang sah dan diizinkan untuk diperjualbelikan;
                        <br/>
                        <br/> 
                        (xxxvi)	Barang curian;
                        <br/>
                        <br/> 
                        (xxxix)	Produk mistis, berupa jimat-jimat atau benda yang diklaim berkekuatan gaib dan/atau
                        memberikan ilmu kesaktian seperti namun tidak terbatas pada santet, pesugihan, jenglot, susuk, dan lain-lain;
                        <br/>
                        <br/> 
                        (xli)		Alat kesehatan yang tidak memiliki izin edar yang tidak boleh diperdagangkan secara bebas berdasarkan ketentuan yang ditetapkan oleh badan pemerintahan atau otoritas pemerintahan karena dianggap sebagai barang yang berpotensi menimbulkan resiko gangguan kesehatan
                        <br/>
                        <br/> 
                        (xliii)		Barang dengan hak Distribusi Eksklusif yang hanya dapat diperdagangkan dengan sistem penjualan langsung oleh penjual resmi dan/atau Barang dengan sistem penjualan Multi Level Marketing;
                        <br/>
                        <br/> 
                        (xliv)	Barang yang tidak memenuhi ketentuan SNI, pelabelan, penggunaan Bahasa Indonesia yang diatur oleh Kementrian Perdagangan.
                        <br/>
                        <br/> 
                        (xlv)		Bahan yang diklasifikasikan sebagai Bahan Berbahaya menurut Peraturan Menteri Perdagangan dan yang berlaku.
                    </p>
                </div>
            </div>
            <!-- //Main Container -->
